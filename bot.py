...
app = Flask(__name__)
# production'da bunu güvenli, rastgele bir değere değiştir
...
SITE_KEY = "6Lfja_MrAAAAADQ2P19yQHgBMrMqdEp7FLRKqccG"

# Gizli anahtar / Secret (backend doğrulama için) - verdiğin değer
SECRET_KEY = "6Lfja_MrAAAAANo_hWv2wOs8m_bJy2KBQF211OWi"
# ------------------------------------
...
def rate_limit_and_verify():
    # verify ve static dosyalarını atla
    ...
    # Eğer kullanıcı doğrulanmamışsa verify sayfasına yönlendir
...
def verify():
    ...
    if request.method == 'POST':
        ...
        if result.get("success"):
            ...
            # opsiyonel: print(result) ile Google'ın döndürdüğü hata kodlarını görebilirsin
